...
public class FRM_RegistroMatricula extends javax.swing.JFrame {
    ...
    public FRM_RegistroMatricula(FRM_RegistroEstudiantes mantenimientoEstudiantes,FRM_RegistroCursos mantenimientoCursos,FRM_MenuPrincipal valor) {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jl_Cedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, -1, -1));

        jl_NombreEstudiante.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jl_NombreEstudiante.setText("Nombre");
        getContentPane().add(jl_NombreEstudiante, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, -1, -1));

        jl_Sigla.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jl_Sigla.setText("Sigla");
        getContentPane().add(jl_Sigla, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 50, -1, -1));

        jl_NombreCurso.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jl_NombreCurso.setText("Nombre");
        getContentPane().add(jl_NombreCurso, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 110, -1, -1));
        getContentPane().add(jt_Cedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 50, 80, -1));

        jt_NombreEstudiante.setEnabled(false);
        getContentPane().add(jt_NombreEstudiante, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 110, 160, -1));
        getContentPane().add(jt_Sigla, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 50, 86, -1));

        jt_NombreCurso.setEnabled(false);
        getContentPane().add(jt_NombreCurso, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 110, 161, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 160, 437, 88));

        gUI_Botones2.setOpaque(false);
        getContentPane().add(gUI_Botones2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 250, -1, 60));
        ...
        getContentPane().add(btn_ConsultaRapidaSigla, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 50, -1, -1));
        ...
        getContentPane().add(btn_ConsultaRapidaEstudiante, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 50, -1, -1));

        jl_CodigoMatricula.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        getContentPane().add(btn_Finalizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 320, -1, 30));
